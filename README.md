...
Official implementation and model weights for the paper: "Key and Value Weights Are Probably All You Need" (arXiv:2510.23912).
...
The codebase is built upon nanoGPT by Andrej Karpathy. The attention mechanism has been modified to support experiments involving tied weights and reduced-parameter projections as described in the paper.


## 📝 Citation

@article{yourname2025key,
